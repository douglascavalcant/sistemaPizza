...
function venda(e){
    if(document.getElementById('mussarela').checked){
        ...
        vendaMussarerla = vendaMussarerla + 25.00

        document.getElementById('resultadoMussarela').innerHTML = somaMussarela
        document.getElementById('vendaMussarela').innerHTML = vendaMussarerla.toFixed(2)
